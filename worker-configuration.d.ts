/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 864df66781995ea9812b7668fa2f22f1)
// Runtime types generated with workerd@1.20251217.0 2024-12-21 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import('./src/index');
	}
	interface Env {
		GSC_TOKENS?: KVNamespace; // Optional - only used for token caching
		API_KEY?: string; // Optional - API key for authenticating client requests (X-API-Key header)
